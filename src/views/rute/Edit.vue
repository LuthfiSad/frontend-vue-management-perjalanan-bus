<template>
        ...
        <form @submit.prevent="_updateDataRute" class="max-w-sm px-4 mx-auto">
            <div class="mb-2">
            ...
            <div class="mb-2">
                ...
                <select class="block w-full py-2 px-3 border-2 border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                    v-model="rute.asal"
                    >
                      <option v-for="terminal in terminalsAll"
            ...
            <div class="mb-2">
                ...
                <div class="flex items-center" v-for="(ruteIterate, i) in rute.checkpoints" :key="i">
